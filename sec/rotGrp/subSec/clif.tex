...
Toliau nagrinėsime nagrinėsime dvi Clifford'o algebras $\Clp$ ir
$\Clm$. Tai yra vektorinės erdvės su papildoma bitiesine daugybos
...
\end{definition}
Kitaip pasakius tai yra algebra, kurios vektoriai yra įvairių ilgiu tenzorinių
...
\begin{example}
	...
	Šią išraišką supaprastiname atlikdami veiksmus
	\begin{equation}
		\begin{split}
			a \otimes (\vb v \otimes \vb w + 2(\vb v,\vb w)\mathbb 1) \otimes b + I^-
			=&
...
\begin{equation}
	...
	\vb e_1 \vb e_2 \vb e_3 ,
\end{equation}
nes su pirma taisykle bet kurį tenzorinės algebros bazės elementą galima išrikiuoti taip kad
...
\begin{example}
	...
	\begin{equation}
		...
		\end{split}
	\end{equation}
	Taip yra tokia pati struktūra kaip $\set Z_2$ su sudėtimi
	\begin{equation}
		\begin{split}
...
\begin{proof}
	...
	\begin{equation}
		...
		\end{aligned}
	\end{equation}
	Tai yra sąryšiai apibrėžiantys Clifford'o algebrą $\mathup{Cl}^-(2)$,
