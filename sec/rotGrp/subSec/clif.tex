...
\begin{definition}
	...
	\end{equation}
\end{definition}
Nesunku pamatyti kad nėra svarbu kokia tvarka pritaikome transponavimas ir automorfizmas $\alpha$,
...
Ši struktūra vadinama algebros $\Clpm$ ,,$Z_2$ gradavimu'', kurį suteikia automorfizmas $\alpha$
Lyginis poerdvis yra uždaras algebros daugybos atžvilgiu,
todė tai yra $\Clpm$ poalgebris.
