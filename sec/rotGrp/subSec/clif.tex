...
Toliau nagrinėsime nagrinėsime dvi Clifordo algebras $\Clp$ ir
$\Clm$. Tai yra vectorinės erdvės su papildoma bitiesine daugybos
...
\begin{example}
	...
	$
	yra šoninė klasė, kuri yra vektorius iš $\Clm$.
...
\begin{definition}
	...
	\begin{equation}
		...
		\,.
	\end{equation}
	Tiesiškai $\alpha$ veikimą išplėčiame ant visos algebros $\Clpm$,
...
Sakome, kad algebrai $\Clpm$ homomorfizmas $\alpha$ suteikia 
