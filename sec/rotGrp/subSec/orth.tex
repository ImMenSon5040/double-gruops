...
{\color{red} Tegul $(\cdot,\cdot) : \mathbb{R}^3 \times \mathbb{R}^3 \to \mathbb{R}$ būna standartinė skaliarinė sandauga.}
...
\begin{equation}
	...
	\end{split}
\end{equation}
Determinantas yra homomorfizmas iš $\Orth3$ į $C_2 = \qty{1,-1}$. To pasekoje $\Orth3$ Yra padalijama į dvi dalis:
tikruosius sukimus (\textit{ang.} proper rotations), kuriems $\det(R) = 1$, ir
netikruosius sukimus (\textit{ang.} improper rotations), kuriems $\det(R) = -1$.
\begin{example}
