...
\begin{definition}
	Diedrinės grupės (ang. \emph{dihedral groups}) yra
	\begin{equation}
...
\begin{proposition}
	Grupė $D_n$ yra izomorfiška pusiau tiesioginei grupių sandaugai $C_n \ltimes C_2$.
...
\begin{proof}
	...
	\begin{equation}
		...
		\end{aligned}
	\end{equation}
	Atvaizdavimams apibrėžti užtenka pateikti,
	į ką siunčiami generatoriai.
	Kiti elementai grupėse yra žodžiai išreikšti generatoriais
...
\begin{definition}
	\textquote{Ciklinės grupės su vertikalia atspindžio plokštuma} yra 
	\begin{equation}
...
\begin{corollary}
	Iš $C_{nv}$ apibrėžimo iškart seka, kad $C_{nv} \cong D_n \cong C_n \ltimes C_2$. 
\end{corollary}

\begin{definition}
	\textquote{Ciklinės grupės su horizontalia atspindžio plokštuma} yra 
	\begin{equation}
...
\begin{proof}
	...
	Apibrėžiantis sąryšis $hr=rh$ atvaizduojamas į tapatybę grupėje $C_n \times C_2$
	\begin{equation}
		(a,e)(e,b) = (a,b) = (e,b)(a,e)
		\,.
	\end{equation}
...
\begin{definition}
	\textquote{Diedrinės grupės su horizontalia atspindžio plokštuma} yra 
	\begin{equation}
		D_{nh} := \present{r,h}{
			r^n=s^2=h^2=e,\,
			srs^{-1}=r^{-1},\,
...
\begin{proof}
	...
	Turint išskaidymą $wh^j$ įrodymas tęsiamas taip pat,
	kaip ir teiginyje \ref{prop:cnh_product}.
\end{proof}
...
\begin{definition}
	...
	\begin{equation}
		...
		\,,
	\end{equation}
	čia generatorius $f$ yra tapatinamas su netikruoju pasukimu vadinamu atspindžiu-posūkiu.
	Atspindys-posūkis yra sudarytas iš dviejų dalių:
	pirma pasukimo kampu $\pi/n$ aplink $z$ ašį,
	antra atspindžio per horizontalią plokštumą statmena $z$ ašiai.
	Ekvivalenčiai $S_{2n}$ galima apibrėžti,
...
\begin{definition}
	\textquote{Diedrinės atspindžių-posūkių grupės} yra
	\begin{equation}
		D_{nd} := \present{f,v}{f^{2n}=v^2=e,\, vfv^{-1}=f^{-1}}
		\,,\quad
		n \in \set N
		\,,
	\end{equation}
	čia generatorius $f$ vėl yra tapatinamas su atspindžiu-posūkiu,
	generatorius $v$ yra tapatinamas su atspindžiu per vertikalią plokštumą.
	Ekvivalenčiai $D_{nd}$ galima apibrėžti,
...
pogrupiai, todėl jos yra vadinamos \emph{achiralinėmis} grupėmis.
