...
\begin{definition}
	...
	\begin{equation}
		...
		\,,
	\end{equation}
	čia generatorius $s$ yra tapatinamas su sukimu kampu $\pi$ aplink ašį einačia per tetraedro briaunos vidurio tašką,
	generatorius $t$ yra tapatinams su sukimu kampu $2\pi/3$ aplink ašį einačia per tetraedro sienos centrą,
	elementas $st$ yra tapatinamas su sukimu kampu $2\pi/3$ aplink ašį einačia per tetraedro viršūnę.
\end{definition}
...
\begin{definition}
	...
	\begin{equation}
		...
		\,,
	\end{equation}
	čia generatorius $s$ yra tapatinamas su sukimu kampu $\pi$ aplink ašį einačia per oktaedro briaunos vidurio tašką,
	generatorius $t$ yra tapatinams su sukimu kampu $2\pi/3$ aplink ašį einačia per oktaedro sienos centrą,
	elementas $st$ yra tapatinamas su sukimu kampu $2\pi/4$ aplink ašį einačia per oktaedro viršūnę.
\end{definition}
...
\begin{definition}
	...
	\begin{equation}
		...
		\,,
	\end{equation}
	čia generatorius $s$ yra tapatinamas su sukimu kampu $\pi$ aplink ašį einačia per ikosaedro briaunos vidurio tašką,
	generatorius $t$ yra tapatinams su sukimu kampu $2\pi/3$ aplink ašį einačia per ikosaedro sienos centrą,
	elementas $st$ yra tapatinamas su sukimu kampu $2\pi/5$ aplink ašį einačia per ikosaedro viršūnę.
\end{definition}
...
\begin{definition}
	...
	generatorius $v$ yra tapatinamas su atspindžiu per plokštūmą,
...
nes jos yra grupės $\SO3$ pogrūpiai.
